$(document).ready(function(){
	...
	$("form").submit(function(){
        ...
        url = "https://www.googleapis.com/youtube/v3/channels?key=AIzaSyBc5SRKGUxYGFTAOvQ8PXTPKjHEeu_WskU&id=" + channelId + "&part=snippet,contentDetails,statistics";
        ...
        setInterval(function(){
             ...
             url = "https://www.googleapis.com/youtube/v3/channels?key=AIzaSyBc5SRKGUxYGFTAOvQ8PXTPKjHEeu_WskU&id=" + channelId + "&part=statistics";
